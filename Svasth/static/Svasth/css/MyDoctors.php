...
<!--<center><img src="svasth.png" width="20%" height="10%" style="margin-top: 20px"></center>-->
<!--<div class="navbar">
  <ul>
 <li><a href="patient_login.php">Login</a></li>
  ...
  <li><a class="active" href="#home">Home</a></li>
         ...
         <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="services.html">My Doctors</a>
			  </li>
              <li class="nav-item">
                <a class="nav-link" href="about.html">My Prescriptions</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="contact.html">My Reports</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="contact.html">Appiontments</a>
              </li>
			  <li class="nav-item">
			  <a class="nav-link" href="patient_login.php">Log Out</a>
			  </li>
            </ul>
          </div>
        </div>
	...
	<section class="home-slider inner-page owl-carousel">
      <div class="slider-item" style="background-image: url('antibiotics.jpg');">
